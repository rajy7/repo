		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "demo ui5 application",
									"targetURL": "#comdemodemoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemodemoui5-display": {
								"semanticObject": "comdemodemoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.demoui5",
									"url": sap.ui.require.toUrl("com/demo/demoui5")
								}
							}
						}
					}
